...
function responseMsg(bot, msg) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const date = msg.date();
        outputLog((_a = weakMapUsrRequestInfo.get(bot)) === null || _a === void 0 ? void 0 : _a.token, { text, alias: alias + ' ' + phones, MentionedMe, room: (_b = room === null || room === void 0 ? void 0 : room.memberAll) === null || _b === void 0 ? void 0 : _b.call(room), date });
        ...
        if (/^(  )/.test(text) || !isSentByMe) {
            ...
            const res = yield axios_1.default.post('https://api.openai.com/v1/engines/text-davinci-003/completions', data, {
                headers: {
            ...
            if (res.choices[0].text) {
                msg.say('我的影子说：' + res.choices[0].text);
            }
        }
    });
}
